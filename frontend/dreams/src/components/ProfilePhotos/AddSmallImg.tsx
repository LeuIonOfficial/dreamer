...
//
    ...
    return(
        <AddImg width={'47.5%'} height={'103px'}>
<ImgInput type='file' accept='image/png, image/jpeg, image/jpg' multiple name ='image' id ='image' />
<svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" fill="currentColor" className="bi bi-camera-fill"
     viewBox="0 0 16 16">
